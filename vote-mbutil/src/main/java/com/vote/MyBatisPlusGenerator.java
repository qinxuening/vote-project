...
public class MyBatisPlusGenerator {
    ...
    private static GlobalConfig initGlobalConfig(String projectPath) {
        ...
        globalConfig.setOutputDir(projectPath + "/vote-mbutil/src/main/java");
        globalConfig.setAuthor("qinxuening");
    ...
    private static TemplateConfig initTemplateConfig() {
        ...
        //不生产controller、service、serviceImpl文件
    ...
    private static InjectionConfig initInjectionConfig(String projectPath) {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/vote-mbutil/src/main/resources/com/vote/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
